...
Public Class LJSession
    ...
    Private m_colMoods As New Collection
    ...
    Public ReadOnly Property Tags() As Collection
        Get
            Return m_colTags
        End Get
    End Property

    Public ReadOnly Property Moods() As Collection
        Get
            Return m_colMoods
        End Get
    End Property
